...
good_cols = c(
    "GEO_ID", "GEOID", "state_nm", "county_nm", "r_index", "source", "ALAND_ac", "hu19", "hu_dense"
    )
...
combine_name = 'national_landuse_restrictiveness_index'
date = '20230222'
...
p1990 = "C:/Users/nelms/Downloads/R13309996_SL140.csv"
df1990 = read.csv(p1990)

p2000 = "C:/Users/nelms/Downloads/R13309999_SL140.csv"
df2000 = read.csv(p2000)

fgdb <- "C:/Users/nelms/OneDrive - PennO365/Penn/2023 Spring/CPLN 600/Garrett_Road/Data/Raw_Data/BaseData.gdb"
ptrcts = "TRCT2000_DelCo"
trcts = st_read(fgdb, layer = ptrcts)

trcts_demo = merge(
    trcts %>% transmute(GEOID = as.character(GEOID10)),
    df1990 %>%
        transmute(
            GEOID = as.character(Geo_FIPS),
            white90 = SE_T012_003,
            pop90 = SE_T012_001,
            pctnwhite90 = 1- white90/pop90
            ),
    on='GEOID'
) %>%
merge(
...
st_write(
    trcts_demo,
    "C:/Users/nelms/OneDrive - PennO365/Penn/2023 Spring/CPLN 600/GR_personal/trct10_demo.shp",
    append=FALSE
)
```
...
p10 = "C:/Users/nelms/OneDrive - PennO365/Penn/2023 Spring/CPLN 600/GR_personal/trct10_demo.shp"
tdn = st_read(p10)

tdn %>% st_drop_geometry() %>%
    group_by(up) %>%
    summarize(
        pctnonwhite_90 = 1 - sum(white90) / sum(pop90),

        pctnonwhite_00 = 1 - sum(white00) / sum(pop00),
        pop_change_0090 = (sum(pop00) - sum(pop90)) / sum(pop90)
    )
